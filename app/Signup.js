      ...
      <div id="signup">
        ...
        <div className="signup-form">
          <form onSubmit={this.signup.bind(this)}>
            ...
            <input type="text" value={this.props.state.username} placeholder="@usuario" name="username" id="username" onBlur={this.validateUser.bind(this)} onChange={this.handleInput.bind(this)}/>
            <If condition={this.props.state.userOkMessage !== null}>
              <label ref="usernameLabel" id="usernameLabel" className={this.props.state.userOk ? 'fadeIn animated ok' : 'fadeIn animated fail'} htmlFor="username">{this.props.state.userOkMessage}</label>
            </If>


            <input type="text" value={this.props.state.name} placeholder="Nombre" name="name" id="name" onChange={this.handleInput.bind(this)}/>
            ...
            <input id="license" type="checkbox" ref="license" value={this.props.state.license} name="license" onChange={this.handleInput.bind(this)} />
            ...
            <If condition ={this.props.state.signupFailMessage !== null}>
              <label ref="submitBtnLabel" id="submitBtnLabel" htmlFor="submitBtn" className="shake animated">{this.props.state.signupFailMessage}</label>
            </If>
...
export default connect(mapStateToProps,{updateSignupForm, validateUser, signup})(Signup);
